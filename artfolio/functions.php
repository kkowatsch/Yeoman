...
function artfolio_add_lightbox() {
    ...
    //fonts
    wp_enqueue_style('lg-font-ttf', '/inc/lightbox/font/lg.ttf');
    wp_enqueue_style('lg-font-woff', '/inc/lightbox/font/lg.woff');
    wp_enqueue_style('lg-font-img', '/inc/lightbox/images/loading.gif');
    ...
    wp_enqueue_script('mousewheel', get_template_directory_uri() . '/inc/lightbox/js/jquery.mousewheel.min.js', array('jquery'), false, true);

    //Plugin for zoom
    wp_enqueue_script('zoom', get_template_directory_uri() . '/inc/lightbox/js/lg-zoom.js', array('jquery'), false, true);
}
